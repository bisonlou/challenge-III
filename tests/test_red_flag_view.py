...
class TestRedFlagView(unittest.TestCase):
    ...
    #     self.assertEqual(self.db_services.count('red-flag'), 2)
    ...
    #     self.assertEquals(self.db_services.count('red-flag'), 2)
    ...
    #     self.assertEqual(self.db_services.
    ...
    #     self.assertEqual(message['status'], 200)
    #     self.assertEqual(self.db_services.count('red-flag'), 1)
    #     self.assertEqual(
    #         (message['data']['message']),
